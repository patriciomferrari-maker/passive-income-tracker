...
export function DashboardTab() {
    ...
    const PIE_COLORS = showValues ? COLORS : ['#1e293b'];
                                        ...
                                        <BarChart data={chartDataArray} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                                            ...
                                            <Bar dataKey="Amortización" stackId="a" fill="#3b82f6">
                                                <LabelList
                                                    dataKey="Total"
                                                    position="top"
                                                    formatter={(value: any) => showValues ? `$${Number(value).toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}` : ''}
